...
pub const Less  = h.makeDyad(.@"<", h.Upcast2, h.AlwaysBool2, LessOp,  &at);
pub const More  = h.makeDyad(.@">", h.Upcast2, h.AlwaysBool2, MoreOp,  &at);
pub const Equal = h.makeDyad(.@"=", h.Upcast2, h.AlwaysBool2, EqualOp, &at);
pub const Not   = h.makeMonad(.@"~", h.Upcast1, h.AlwaysBool1, NotOp,  &at);
